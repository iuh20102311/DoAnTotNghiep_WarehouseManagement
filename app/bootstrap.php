...
$router->group(array('prefix' => '/api'), function (RouteCollector $router) {
    ...
    $router->group(array('before' => 'auth'), function (RouteCollector $router) {
        $router->group(array('prefix' => '/v1/reports'), function (RouteCollector $router) {
            $router->get('/stats', ['App\Controllers\ReportStats', 'getStats']);
        });
        ...
        $router->group(array('prefix' => '/v1/material_export_receipts'), function (RouteCollector $router) {
            ...
            $router->get('/{code}', ['App\Controllers\MaterialExportReceiptController', 'getMaterialExportReceiptByCode']);
        ...
        $router->group(array('prefix' => '/v1/product_export_receipts'), function (RouteCollector $router) {
            ...
            $router->get('/{code}', ['App\Controllers\ProductExportReceiptController', 'getProductExportReceiptByCode']);
        ...
        $router->group(array('prefix' => '/v1/product_import_receipts'), function (RouteCollector $router) {
            ...
            $router->get('/{code}', ['App\Controllers\ProductImportReceiptController', 'getProductImportReceiptByCode']);
